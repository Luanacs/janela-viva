package com.janelaviva.janelaviva.service;
...
import com.janelaviva.janelaviva.model.UsuarioLogin;
import com.janelaviva.janelaviva.repository.UsuarioRepository;
...
public class UsuarioService {
	...
	public Optional<UsuarioLogin> logarUsuario(
		...
		.findByEmail(usuarioLogin.get().getUsuario());
		...
		if (usuario.isPresent()) {
			if (compararSenhas(usuarioLogin.get().getSenha(), 
				...
				usuarioLogin.get().setUsuario(usuario.get().getEmail());
